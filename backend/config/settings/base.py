"""
Base settings for Defense Coaching Center & IQ Test Platform.
...
# STATICFILES_STORAGE set in production.py for WhiteNoise
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Defense Coaching Center & IQ Test Platform API',
    'DESCRIPTION': 'RESTful API for managing IQ tests, users, payments, and results',
    'VERSION': '1.0.0',
